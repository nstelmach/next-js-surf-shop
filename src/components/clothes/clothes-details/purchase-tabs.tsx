...
export default function PurchaseTabs({auctionPrice}: PurchaseTabsProps) {
    return <Tabs defaultValue="buy" className="flex flex-col justify-center items-center w-full xl:max-w-lg">
        <TabsList>
        ...
        <TabsContent value="bid" className="flex-col gap-2">
            <Paragraph className="xl:text-base text-xl md:text-2xl">Current price: {auctionPrice} €</Paragraph>
            <div className="grid w-full max-w-sm items-center gap-2 m-2">
                <Label htmlFor="price">Your Price</Label>
                <Input type="text" id="price" placeholder="Price"/>
                <ButtonWithToast type="button"
