...
const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      "Feel Amazing Sweat in Vintage White is an oversized sweatshirt, created in collaboration with the artist Jungle Daisy. Made of exceptionally thick, organic cotton with a weight of 500g, which provides warmth and comfort all day long, regardless of the weather.\n" +
      "\n" +
  ...
  },
  {
    ...
    description:
      "The Stamp Cats Hoodie in Acid Black is a unique hoodie model, designed in collaboration with the talented artist Jungle Daisy. The oversized cut with dropped shoulders, high cuffs at the bottom and a comfortable two-layer hood give the sweatshirt a modern character, while providing full freedom of movement.\n" +
      "\n" +
  ...
  },
  {
    ...
    description:
      "Wine and Surf Sweat is a strong item in the collection, reminiscent of the real 90s. Casual form and delicate oversize, extremely classic and universal color combination. Lowered shoulder line, giving lightness, looseness and nonchalance. The perfect base for many styles - a sweatshirt for literally everything! On the front, old-school, yet minimalist embroidery in the shade of Bottle Green, combined with a detail of embroidered waves on the sleeve and neck. Made of high-quality brushed cotton, soft and pleasant to the body, with a weight of 320G - ensuring durability and reliability in all conditions.",
    price: { create: [{ price: 90 }] },
    size: [Size.XS, Size.S, Size.M, Size.L, Size.XL],
    images: {
      create: [
        {
  ...
  },
  {
    ...
    description:
      "Feel Amazing LS is an oversized unisex longsleeve with a dropped sleeve line, created in collaboration with artist Jungle Daisy. The model is made of 100% organic cotton with a weight of 270g, which has undergone a softening process, ensuring comfort of wearing all day long.\n" +
      "\n" +
  ...
  },
  {
    ...
    description:
      "Face Shine LS in Raspberry Punch is an oversized unisex longsleeve, created in collaboration with the talented artist Jungle Daisy. Made from 100% organic cotton with a weight of 180g, it has undergone a softening process for maximum comfort.\n" +
      "\n" +
      'Ribbed cuffs and a wide neck band guarantee a comfortable fit, while the oversized cut provides complete freedom. In the side seam you will find the "Snake & Moon" pennant. Details such as contrasting chain stitch on the shoulders and a hanger on the neck complete the whole, emphasizing the functionality and aesthetics of this model. Made in Poland.\n' +
      "\n" +
